...
pos_array=[]
try:	
	vehicle1= connect('udpin:192.168.6.151:14551',baud=115200, heartbeat_timeout=30)
...
try:		
	vehicle2= connect('udpin:192.168.6.151:14552',baud=115200,heartbeat_timeout=30)
...
try:
	vehicle3= connect('udpin:192.168.6.151:14553',baud=115200,heartbeat_timeout=30)
...
try:		
	vehicle4= connect('udpin:192.168.6.151:14554',baud=115200,heartbeat_timeout=30)
...
try:		
	vehicle5= connect('udpin:192.168.6.151:14555',baud=115200,heartbeat_timeout=30)
...
try:
	vehicle6= connect('udpin:192.168.6.151:14556',baud=115200,heartbeat_timeout=30)
...
try:
	vehicle7= connect('udpin:192.168.6.151:14557',baud=115200,heartbeat_timeout=30)
...
try:
	vehicle8= connect('udpin:192.168.6.151:14558',baud=115200,heartbeat_timeout=30)
...
try:	
	vehicle9= connect('udpin:192.168.6.151:14559',baud=115200,heartbeat_timeout=30)
...
try:	
	vehicle10= connect('udpin:192.168.6.151:14560',baud=115200,heartbeat_timeout=30)
