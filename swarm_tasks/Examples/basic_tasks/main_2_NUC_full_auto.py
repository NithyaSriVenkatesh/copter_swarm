...
while True:
	...
	try:
		...
		try:
			...
			with open(r'/home/dhaksha/Downloads/main_2nodes/main/dce_swarm_nav/swarm_tasks-main/swarm_tasks/Examples/basic_tasks/pos.csv', 'a') as csvfile:
...
csv_file_path = "/home/dhaksha/Downloads/main_2nodes/main/dce_swarm_nav/swarm_tasks-main/swarm_tasks/Examples/basic_tasks/uav_data_log.csv" 
csv_file_path1 = "/home/dhaksha/Downloads/main_2nodes/main/dce_swarm_nav/swarm_tasks-main/swarm_tasks/Examples/basic_tasks/waypoints.csv" 
nextwaypoint=0
...
vehicles=[]
pos_array=[]
heartbeat_ip=["192.168.6.101","192.168.6.102","192.168.6.103","192.168.6.104","192.168.6.105","192.168.6.106","192.168.6.107","192.168.6.108","192.168.6.109","192.168.6.110"]
#heartbeat_ip=["192.168.6.152"]*10
#heartbeat_ip=["192.168.6.101","192.168.6.102","192.168.6.152","192.168.6.152","192.168.6.152","192.168.6.152","192.168.6.152","192.168.29.108","192.168.29.109","192.168.29.110"]
...
#if master_flag:
try:	
	vehicle1= connect('udpin:192.168.6.152:14551',baud=115200, heartbeat_timeout=heartbeat_ip_timeout[0])
...
try:		
	vehicle2= connect('udpin:192.168.6.152:14552',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[1])
...
try:
	vehicle3= connect('udpin:192.168.6.152:14553',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[2])
...
try:		
	vehicle4= connect('udpin:192.168.6.152:14554',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[3])
...
try:		
	vehicle5= connect('udpin:192.168.6.152:14555',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[4])
...
try:
	vehicle6= connect('udpin:192.168.6.152:14556',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[5])
...
try:
	vehicle7= connect('udpin:192.168.6.152:14557',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[6])
...
try:
	vehicle8= connect('udpin:192.168.6.152:14558',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[7])
...
try:	
	vehicle9= connect('udpin:192.168.6.152:14559',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[8])
...
try:	
	vehicle10= connect('udpin:192.168.6.152:14560',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[9])
...
slave_heal_ip=["192.168.6.152"]*len(vehicles)
...
def vehicle_collision_moniter_receive():	
        global index
        global vehicles
        global slave_heal_ip,master_flag,master_num
        while 1:
        	index, address = sock3.recvfrom(1024)
        	print ("msg!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!", index)
...
while(1):
	try:            
		...
		if data.startswith(b"share_data"):	
			...
			goal_table=json.loads(goal_table)
			print("goal_table",goal_table)
			with open(r'/home/dhaksha/Downloads/main_2nodes/main/dce_swarm_nav/swarm_tasks-main/swarm_tasks/Examples/basic_tasks/pos.csv', 'w') as csvfile:
					fieldnames = ['waypoint']
					writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
				...
				while 1:
					...
					if(step==1):											
						for i,b in enumerate(s.swarm):
							...
							with open('/home/dhaksha/Downloads/main_2nodes/main/dce_swarm_nav/swarm_tasks-main/swarm_tasks/Examples/basic_tasks/pos.csv','rt')as text:
