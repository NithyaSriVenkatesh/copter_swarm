...
uav3_server_address = ('192.168.6.157', 12002)
...
#uav5_server_address = ('192.168.6.152', 12002)
...
#heartbeat_ip_timeout=[3,3,3,30,3,3,3,3,3,3]
goal_path_csv_array=[]
...
slave_heal_ip=["192.168.6.152"]*num_bots
			...
			while 1:	
				...
				for i,b in enumerate(s.swarm):
					...
					if(heartbeat[i]>10):
						...
						print("home_pos,removed_uav_homepos_array",home_pos,removed_uav_homepos_array,len(home_pos))
					'''
					#print("csv_file_paths.get(i)", csv_file_paths.get(i))
    
					goal_lat_lon = read_specific_line(csv_file_paths.get(i), grid_path_array[i])
