...
uav1_server_address = ('192.168.29.151', 12002)  #receive from .....rx.py
uav2 = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
uav2_server_address = ('192.168.29.152', 12002)  #receive from .....rx.py
uav3 = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
uav3_server_address = ('192.168.29.153', 12002)
uav4 = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
uav4_server_address = ('192.168.29.154', 12002)
...
while True:
	...
	try:
		...
		try:
			...
			with open(r'/home/dhaksha/Desktop/main_2nodes/main/dce_swarm_nav/swarm_tasks-main/swarm_tasks/Examples/basic_tasks/pos.csv', 'a') as csvfile:
...
if(file_name=="dce_airport"):
	...
	area_covered_percent=25
	
csv_file_path = "/home/dhaksha/Desktop/main_2nodes/main/dce_swarm_nav/swarm_tasks-main/swarm_tasks/Examples/basic_tasks/uav_data_log.csv" 
csv_file_path1 = "/home/dhaksha/Desktop/main_2nodes/main/dce_swarm_nav/swarm_tasks-main/swarm_tasks/Examples/basic_tasks/waypoints.csv" 
nextwaypoint=0
...
vehicles=[]
pos_array=[]
heartbeat_ip=["192.168.29.101","192.168.29.102","192.168.29.103","192.168.29.104","192.168.29.105","192.168.29.106","192.168.29.107","192.168.29.108","192.168.29.109","192.168.29.110"]
#heartbeat_ip=["192.168.29.153"]*10
#heartbeat_ip=["192.168.29.101","192.168.29.102","192.168.29.153","192.168.29.153","192.168.29.153","192.168.29.153","192.168.29.153","192.168.29.108","192.168.29.109","192.168.29.110"]
heartbeat_ip_timeout=[0]*10
heartbeat_ip_timeout=[3,30,30,3,3,3,3,3,3,3]
goal_path_csv_array=[]
...
def vehicle_connection():	
	...
	pos_array=[]
	try:	
		vehicle1= connect('udpin:192.168.29.153:14551',baud=115200, heartbeat_timeout=heartbeat_ip_timeout[0])
	...
	try:		
		vehicle2= connect('udpin:192.168.29.153:14552',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[1])
	...
	try:
		vehicle3= connect('udpin:192.168.29.153:14553',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[2])
	...
	try:		
		vehicle4= connect('udpin:192.168.29.153:14554',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[3])
	...
	try:		
		vehicle5= connect('udpin:192.168.29.153:14555',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[4])
	...
	try:
		vehicle6= connect('udpin:192.168.29.153:14556',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[5])
	...
	try:
		vehicle7= connect('udpin:192.168.29.153:14557',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[6])
	...
	try:
		vehicle8= connect('udpin:192.168.29.153:14558',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[7])
	...
	try:	
		vehicle9= connect('udpin:192.168.29.153:14559',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[8])
	...
	try:	
		vehicle10= connect('udpin:192.168.29.153:14560',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[9])
...
slave_heal_ip=["192.168.29.153"]*num_bots
...
while(1):
	...
	try:            
		...
		if data.startswith(b"share_data"):	
			...
			goal_table=json.loads(goal_table)
			print("goal_table",goal_table)
			with open(r'/home/dhaksha/Desktop/main_2nodes/main/dce_swarm_nav/swarm_tasks-main/swarm_tasks/Examples/basic_tasks/pos.csv', 'w') as csvfile:
					fieldnames = ['waypoint']
					writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
			...
			if master_flag:
				...
				serialized_data = json.dumps(home_pos)
				serialized_data="home_pos" + serialized_data
				print("serialized_dataHOME%%%%",serialized_data)
				sent = graph_socket.sendto(serialized_data.encode(), graph_server_address)
				time.sleep(0.2)
				uav1.sendto(serialized_data.encode(),uav1_server_address)
				time.sleep(0.2)
				...
				serialized_data = json.dumps(uav_home_pos)
				serialized_data="uav_home_pos" + serialized_data
				print("serialized_dataUAV___HOME%%%%",serialized_data)
				sent = graph_socket.sendto(serialized_data.encode(), graph_server_address)
				time.sleep(0.2)
				uav1.sendto(serialized_data.encode(),uav1_server_address)
				time.sleep(0.2)
				...
				while 1:
					...
					if(step==1):											
						for i,b in enumerate(s.swarm):
							...
							with open('/home/dhaksha/Desktop/main_2nodes/main/dce_swarm_nav/swarm_tasks-main/swarm_tasks/Examples/basic_tasks/pos.csv','rt')as text:
